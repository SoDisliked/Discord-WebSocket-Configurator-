    ...
    public class SocketWrapper : ISocket
    {
        ...
        public string RemoteIpAdress
        {
            get
            {
                ...
                return endpoint != null ? endpoint.Adress.ToString() : null;
            }
        }
        ...
        public SocketWrapper(Socket socket)
        {
            ...
            // The tcp keepalive default values on most systems including Discord
